            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form
                            action="{{ route('admin.products.edit.detail', ['product' => $data['product_parent'], 'id' => $data['product']->id]) }}"
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <select name="color_id" id="color_id" class="form-control">
                                        @forelse ($data['colors'] as $item)
                                            <option value={{ $item->id }}
                                                {{ $data['product']->product_id == $item['id'] ? 'selected' : '' }}>
                                                {{ $item->name }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <select name="size_id" id="size_id" class="form-control">
                                        @forelse ($data['sizes'] as $item)
                                        <option value={{ $item->id }}
                                            {{ $data['product']->size_id == $item['id'] ? 'selected' : '' }}>
                                            {{ $item->name }}</option>
                                    @empty
                                    @endforelse
                                    </select>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input value="{{$data['product']->quantity}}" name="quantity" type="number" class="form-control" step="1"
