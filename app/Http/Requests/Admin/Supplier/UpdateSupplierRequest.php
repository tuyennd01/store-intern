...
class UpdateSupplierRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ['required', 'string', 'min:' . config('validate.min.supplier.name'), 'unique:suppliers,name,' . $this->name . ',name'],
            ...
            'address' => ['required', 'string', 'max:' . config('validate.max.address')],
        ];
    }
}
